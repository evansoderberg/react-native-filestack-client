...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSStorageAccess, "StorageAccess", closed) {
/// Private
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSStorageLocation, "StorageLocation", closed) {
/// Amazon S3
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformAlign, "TransformAlign", closed) {
/// Center
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformAspectMode, "TransformAspectMode", closed) {
/// Preserve
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformBlurMode, "TransformBlurMode", closed) {
/// Linear
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformColorSpace, "TransformColorSpace", closed) {
/// RGB
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformCropMode, "TransformCropMode", closed) {
/// Thumb
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformFiletype, "TransformFiletype", closed) {
/// doc
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformFit, "TransformFit", closed) {
/// Clip
...
/// Represents an image transform noise reduction type.
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformNoiseMode, "TransformNoiseMode", closed) {
/// None
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformPageFormat, "TransformPageFormat", closed) {
/// A3
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformPageOrientation, "TransformPageOrientation", closed) {
/// Portrait
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformShapeType, "TransformShapeType", closed) {
/// Rect
...
typedef SWIFT_ENUM_NAMED(NSUInteger, FSTransformStyleMode, "TransformStyleMode", closed) {
/// Artwork
